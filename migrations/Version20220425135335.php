 ...
 */
final class Version20220425135335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_blog (id INT AUTO_INCREMENT NOT NULL, category_blog_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, post_date DATETIME NOT NULL, INDEX IDX_7057D6421D383EE9 (category_blog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
